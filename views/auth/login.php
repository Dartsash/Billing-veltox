    ...
    <div class="auth-frame">
      <div class="row g-0">
        <div class="col-lg-6">
          <div class="auth-hero">
            ...
            <div class="auth-pills">
              <div class="auth-pill"><i class="bi bi-shield-check me-1"></i> Оплата и счета</div>
              <div class="auth-pill"><i class="bi bi-lightning-charge me-1"></i> Баланс и тарифы</div>
              <div class="auth-pill"><i class="bi bi-hdd-network me-1"></i> Поддержка</div>
            </div>

            <div class="mt-4 auth-note">
              <i class="bi bi-info-circle me-1"></i>
              Если нет аккаунта, нажми регистрацию
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="auth-form">
            <h1>Вход</h1>
            <p>Введи данные и пройди капчу.</p>
            ...
            <form method="post" action="/login" class="d-grid gap-3">
              ...
              <button class="auth-btn w-100" type="submit">
